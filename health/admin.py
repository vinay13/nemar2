...
from .models import MedicalOperate,Specialize,DoctorList,Meanbloodglucose,Bloodpressurechart,Region,Cholestrolriskchart
...
class DoctorListAdmin(admin.ModelAdmin):
    list_display=('id','name','home_address','clinic_address','specialize','region','contact_no')
